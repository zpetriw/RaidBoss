...
public abstract class Unit : MonoBehaviour
{
    ...
    /// <summary>
    /// Note that this may be moved to Skill, since it is a Skill that attacks a Unit, not a Unit attacking a Unit. 
    /// </summary>
    ...
    /// <summary>
    /// This is the unit's current hit points. 
    /// </summary>
    public int HitPoints;
    public int AttackRange;
    /// <summary>
    /// This is the unit's basic attack. It can be increased or lowered. 
    /// </summary>
    public int AttackFactor;
    /// <summary>
    /// This is the unit's basic defense. It can be increased or lowered. 
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    /// We could definitely override this so that the object isn't destroyed but rather just turns grey. 
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// We'll need to repeal and replace this will the Skill determining whether the unit is "attackable".
    /// Really, this should be called "valid target" instead, since it might target allies or self instead. 
    /// </remarks>
    ...
    /// Note: I want to remove this. 
    /// Units will no longer deal damage to units. 
    /// Skills will deal damage to units, and units can defend against Skills based on their defense and resistances, 
    /// which may influenced by status effects (buffs and debuffs). 
    /// </summary>
    /// <remarks>
    /// For now we'll leave this in so that code can compile but eventually it should be commented out (but kept for reference). 
    /// </remarks>
...
/// <summary>
/// We could probably beef up this class to include the incoming skill (and its power?) in the EventArgs.
/// We could even separate this into an action of some sort, so that it's not inherintly an "attack". 
/// For example, it could be an incoming heal or self buff.
/// </summary>
