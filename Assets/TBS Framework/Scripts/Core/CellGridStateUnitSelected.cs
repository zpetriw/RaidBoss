...
class CellGridStateUnitSelected : CellGridState
{
    ...
    /// <summary>
    /// Would we fire this when selecting a unit? 
    /// </summary>
    /// <param name="cell"></param>
    /// <remarks>
    /// It appears like this is called when an empty cell is clicked. 
    /// </remarks>
    public override void OnCellClicked(Cell cell)
    {
        ...
        {
            // If this cell is not in range of the unit, then this cell will then be waiting for input. 
            _cellGrid.CellGridState = new CellGridStateWaitingForInput(_cellGrid);
        }
        else
        {
            // If this cell is within range of the selected unit, then the selected unit needs to move to it. 
    ...
    /// <summary>
    /// This is fired when a unit is selected. 
    /// Would we put our code here? Or in "OnCellClicked"?
    /// We need to figure out where to open a menu that will allow a skill to be chosen. 
    /// </summary>
    /// <param name="unit"></param>
    /// <remarks>
    /// I think in here we need to figure out if a skill is currently active. 
    /// If it is, then this unit becomes the target for the skill if it is a valid target. 
    /// </remarks>
    ...
    /// <summary>
    /// When is this called? 
    /// It seems like it's called whenever the state of a cell is changed. 
    /// </summary>
